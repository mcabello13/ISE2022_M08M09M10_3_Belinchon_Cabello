...
/* Last-Modified: Thu, 31 Mar 2022 15:44:46 GMT */
const uint32_t imageLastModified = 1648741486U;

static const uint8_t imageFileData[27556U] = {

  /*-- File: index.htm, 2472 bytes --*/
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0x1D1F9D3EU, &imageFileData[2472U]  },    // "pg_header.inc"
  { 0x85C7B8E6U, &imageFileData[3520U]  },    // "pg_footer.inc"
  { 0xF8334615U, &imageFileData[3946U]  },    // "ad.cgi"
  { 0xB0E380D2U, &imageFileData[6224U]  },    // "ad.cgx"
  { 0xF46138EAU, &imageFileData[6293U]  },    // "buttons.cgi"
  { 0xBCB1FE2DU, &imageFileData[7575U]  },    // "buttons.cgx"
  { 0xD7FABA9AU, &imageFileData[7683U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[8587U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[9523U]  },    // "leds.cgi"
  { 0xCEC97D75U, &imageFileData[11230U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[12777U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14028U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[14672U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[17488U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[18877U] },    // "keil.gif"
  { 0x7049A0E1U, &imageFileData[20015U] },    // "llblue.jpg"
  { 0xA35A02C8U, &imageFileData[23023U] },    // "logo.gif"
  { 0x3BDBDB05U, &imageFileData[27435U] },    // "pabb.gif"
