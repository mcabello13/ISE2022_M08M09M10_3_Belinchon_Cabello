...
extern char overload [2];
extern char ganancia_combo1;
extern char ganancia_combo2;
extern char g_o[2][20+1];
extern int ganancia;
...
uint32_t cgi_script (const char *env, char *buf, uint32_t buflen, uint32_t *pcgi) {
  ...
  switch (env[0]) {
    ...
    case 'g':
      ...
      len = sprintf (buf, &env[4], ganancia_combo1 ? "checked" : "");
      
			
			/*switch (env[2])
			{			
			  case '1': //Combo para Ganancia.									 				
					
					len = sprintf (buf, &env[4], ganancia_combo1);
					
					if(ganancia_combo1 == 5)
					{
						ganancia = 5;
					}
					else if(ganancia_combo1 == 10)
					{
						ganancia = 10;
					}
					else if(ganancia_combo1 == 50)
					{
						ganancia = 10;
					}
					else if(ganancia_combo1 == 100)
					{
						ganancia = 10;
					}
					else
          ...
          len = sprintf (buf, &env[4], overload);
